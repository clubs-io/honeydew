...
const client = process.env.POSTMARK_CLIENT ? new Postmark.ServerClient(process.env.POSTMARK_CLIENT) : null;
        ...
        if (client){
          ...
          await client.sendEmailWithTemplate({
            ...
            TemplateModel: {
              ...
              invite_sender_organization_name: orgName ? orgName.name : "HoneyDew",
